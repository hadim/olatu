...
const MESSAGES = {
  en: {
    ...
    'glossary.directionScale': 'Swell-direction colours',
    'glossary.directionScaleNote': 'The direction track and the dial tint each reading by where the swell comes from.',
    'glossary.candhisField': 'CANDHIS field',
    'glossary.typical': 'Typical',
    'gloss.range.waveHeight': 'typically 0.3–5 m, median ≈ 1.2 m',
    'gloss.range.maxWave': '≈ 1.6–2× the wave height',
    'gloss.range.period': 'often ≈ 11 s (≈ 6–18 s)',
    'gloss.range.direction': 'clusters W–NW, ~290–310°',
    'gloss.range.spread': '~10–40° (small = clean swell)',
    'gloss.range.seaTemp': '≈ 11–25 °C over the year',
    'date.pickRange': 'Pick a date range',
    'date.prevMonth': 'Previous month',
    'date.nextMonth': 'Next month',
    'date.hasData': 'Has data',
    'date.bigSwell': 'Big swell',
    'sea.glassy': 'glassy',
    'sea.smooth': 'smooth',
  ...
  fr: {
    ...
    'glossary.directionScale': 'Couleurs de direction de la houle',
    'glossary.directionScaleNote': 'Le graphique de direction et le cadran teintent chaque mesure selon la provenance de la houle.',
    'glossary.candhisField': 'Champ CANDHIS',
    'glossary.typical': 'Habituel',
    'gloss.range.waveHeight': 'en général 0,3–5 m, médiane ≈ 1,2 m',
    'gloss.range.maxWave': '≈ 1,6–2× la hauteur des vagues',
    'gloss.range.period': 'souvent ≈ 11 s (≈ 6–18 s)',
    'gloss.range.direction': 'surtout O–NO, ~290–310°',
    'gloss.range.spread': '~10–40° (faible = houle propre)',
    'gloss.range.seaTemp': '≈ 11–25 °C sur l’année',
    'date.pickRange': 'Choisir une plage de dates',
    'date.prevMonth': 'Mois précédent',
    'date.nextMonth': 'Mois suivant',
    'date.hasData': 'Données',
    'date.bigSwell': 'Grosse houle',
  ...
  es: {
    ...
    'glossary.directionScale': 'Colores de dirección del oleaje',
    'glossary.directionScaleNote': 'El gráfico de dirección y el dial colorean cada lectura según de dónde viene el oleaje.',
    'glossary.candhisField': 'Campo CANDHIS',
    'glossary.typical': 'Habitual',
    'gloss.range.waveHeight': 'normalmente 0,3–5 m, mediana ≈ 1,2 m',
    'gloss.range.maxWave': '≈ 1,6–2× la altura de las olas',
    'gloss.range.period': 'a menudo ≈ 11 s (≈ 6–18 s)',
    'gloss.range.direction': 'sobre todo O–NO, ~290–310°',
    'gloss.range.spread': '~10–40° (baja = oleaje limpio)',
    'gloss.range.seaTemp': '≈ 11–25 °C durante el año',
    'date.pickRange': 'Elegir un rango de fechas',
    'date.prevMonth': 'Mes anterior',
    'date.nextMonth': 'Mes siguiente',
    'date.hasData': 'Con datos',
    'date.bigSwell': 'Marejada grande',
